...
| onBackBtnClick | (index) => {}     |                         | function to call when the Back button click                                                                                                                                                                                                                                                                                                                      |
...
| showBackButton | bool | false | a boolean defining if we should render the back button. To render the Back button, this needs to be true and `showSkipButton` needs to be false |
